...
from DeepNet.deeptoxic.models.pytorch import dropout
...
def mini_batches_generator(inputs, targets, batch_size, row_shuffle=False):
    ...
    for batch_xs, batch_ys in mini_batches:
        ...
        max_length = min(model_config.MAX_SEQUENCE_LENGTH, max(lengths))
        ...
        inputs_tensor = torch.from_numpy(batch_tensors).long()  # to avoid a copy, using from_numpy
        ...
        # lengths_var is for masking operation
