...
from keras.layers import Dense, Input, Embedding, Lambda, Dropout, Activation, merge, Flatten, Bidirectional
from keras.layers import SpatialDropout1D, Reshape, GlobalAveragePooling1D, CuDNNGRU, add, Conv1D, GlobalMaxPooling1D
